...
# + id="1WmRh0a3Zc6O"
# The following is basically source data
# The real fun starts in the next code cell
...
# + colab={"base_uri": "https://localhost:8080/", "height": 676} id="AOPgAyEkaJQo" outputId="85897dae-237f-4e78-e393-30bc7067a1ee"
mentor = Mentor()
...
# + colab={"base_uri": "https://localhost:8080/", "height": 641} id="sYVwE1KHXHv7" outputId="81c3fb2a-b808-45d2-ee10-1aa15e8f37b9"
mentee = Mentee()
...
# + colab={"base_uri": "https://localhost:8080/", "height": 214} id="nHpMJVYB08D4" outputId="b61a9b83-e439-4b1e-c262-7921b9232acf"
mentor_df.head(1)
...
for i in range(len(mentor_df)):
    ...
    for skill in skills:
        if skill in mentor_df.at[i, 'skills']:
            mentor_df.at[i, skill] = 1

    # OHE time zone

    for time in time_zones:
        if time in mentor_df.at[i, 'time_zone']:
            mentor_df.at[i, time] = 1

    # OHE 'technical' vs 'career preparation'

    mentor_df['Technical'] = 1
    if mentor_df.at[i, 'career_capable']:
        mentor_df.at[i, 'Career Preparation'] = 1


# + colab={"base_uri": "https://localhost:8080/", "height": 363} id="HcJ_JALT4QpA" outputId="e0103f78-5f97-4560-9895-56b6535da7c6"
mentor_df.head(3)
...
for i in range(len(mentee_df)):
    ...
    for skill in skills:
        if skill in mentee_df.at[i, 'desired_skills']:
            mentee_df.at[i, skill] = 1

    # OHE time zone

    for time in time_zones:
        if time in mentee_df.at[i, 'time_zone']:
            mentee_df.at[i, time] = 1

    # OHE purpose

    for j in purpose:
        if j in mentee_df.at[i, 'tech_or_career']:
            mentee_df.at[i, j] = 1


# + colab={"base_uri": "https://localhost:8080/", "height": 294} id="FHroxeO14V0r" outputId="3df44a22-50e4-4ef3-f11a-e9ee472437c4"
mentee_df.head(3)
...
# + colab={"base_uri": "https://localhost:8080/", "height": 81} id="G-qI5XyIXMpT" outputId="0a906501-b1e3-4515-88f7-18f83b48ea27"
...
# + colab={"base_uri": "https://localhost:8080/", "height": 81} id="dRplgeaXWsh3" outputId="cd3aad50-6171-4f53-a35e-352a59c099ef"
...
for i in range(len(mentor_df)):
    ...
    if not mentor_df.at[i, 'Career Preparation']:
        mentee_df_copy = mentee_df_copy[mentee_df_copy['Technical'] == 1]
    ...
    mentee_df_copy = mentee_df_copy[mentee_df_copy[mentor_time_zone] == 1]
...
# + colab={"base_uri": "https://localhost:8080/", "height": 309} id="TFrgMqo3g2tY" outputId="c8637d81-6517-4230-9099-cc4cf3234384"
mentor_df.head(3)
...
# + colab={"base_uri": "https://localhost:8080/"} id="llAfrmRkYJzE" outputId="f9985a98-298b-4864-c12f-a7c4ac49d455"
...
# + colab={"base_uri": "https://localhost:8080/", "height": 81} id="vqii_ALhhtCx" outputId="96155230-b1d3-4b0f-8e01-68e0a47ff234"
...
mentee_rec_1_profile_id = mentor_df.at[0, 'mentee_rec_1'][0]
mentee_rec_2_profile_id = mentor_df.at[0, 'mentee_rec_2'][0]
mentee_rec_3_profile_id = mentor_df.at[0, 'mentee_rec_3'][0]
mentee_rec_4_profile_id = mentor_df.at[0, 'mentee_rec_4'][0]
mentee_rec_5_profile_id = mentor_df.at[0, 'mentee_rec_5'][0]
...
# + id="MU6KcOLxiG1o"
mentee_1_df = mentee_df[mentee_df['profile_id'] == mentee_rec_1_profile_id]
mentee_2_df = mentee_df[mentee_df['profile_id'] == mentee_rec_2_profile_id]
mentee_3_df = mentee_df[mentee_df['profile_id'] == mentee_rec_3_profile_id]
mentee_4_df = mentee_df[mentee_df['profile_id'] == mentee_rec_4_profile_id]
mentee_5_df = mentee_df[mentee_df['profile_id'] == mentee_rec_5_profile_id]


# + colab={"base_uri": "https://localhost:8080/", "height": 206} id="ERLRb6vXmaa4" outputId="27c8334d-3458-4380-e35b-ab346d87265c"
...
# + colab={"base_uri": "https://localhost:8080/"} id="VDzbpnXKnYIy" outputId="315247d7-622a-4a8e-87cf-6dcc3e50777e"
# Mentor skills
