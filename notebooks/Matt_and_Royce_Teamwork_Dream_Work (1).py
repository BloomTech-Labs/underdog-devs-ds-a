...
# + colab={"base_uri": "https://localhost:8080/", "height": 1000} id="eLSEvUAPFuir" outputId="c534ca06-3fb8-43ae-e279-ec98044feeab"
mentor_df

# + colab={"base_uri": "https://localhost:8080/", "height": 424} id="zI-m9SusFwWp" outputId="0f4c0f2b-1c75-45aa-aee1-a3ab6f23b21d"
mentee_df
...
# + colab={"base_uri": "https://localhost:8080/"} id="fVme8fpmInuz" outputId="f50ba3dc-2054-4aa8-dd7c-2f81dce198c4"
clean_data(mentor_df).shape

# + colab={"base_uri": "https://localhost:8080/"} id="ocUTua6MGKTd" outputId="f44f778a-1560-404c-ff90-7a352f383ef3"
clean_data(mentee_df).shape

# + id="PnE_ay_hE0zg"
cos_model_df = cosine_similarity(clean_data(mentee_df),clean_data(mentor_df))

# + id="1iQrEcD-11fz" colab={"base_uri": "https://localhost:8080/"} outputId="569b3ad5-e01f-43b9-abcd-5cc92b808c87"
cos_model_df.shape

# + id="EAUVbLXX6p53"
cos_model_df = pd.DataFrame(cos_model_df,index=mentee_df.full_name_mentee,columns=mentor_df.full_name_mentor)

# + colab={"base_uri": "https://localhost:8080/"} id="3Ico9_ptL7ga" outputId="7cf3c2e9-f3ec-4141-ceda-6ce20f8627c2"
cos_model_df.mean()

# + colab={"base_uri": "https://localhost:8080/", "height": 424} id="zg6uVrYa2mN6" outputId="ddb377a3-84aa-4ab6-ccea-9900160ff515"
cos_model_df = cos_model_df.unstack().reset_index()
cos_model_df

# + id="BT3fklPj2ieY"
cos_model_df = cos_model_df.sort_values(by = ['full_name_mentee', 0], ascending=False)

# + id="ECKxyxoirwmw" colab={"base_uri": "https://localhost:8080/", "height": 1000} outputId="cbc58900-f41e-4c12-acee-98db4af96662"
Desmond_Roberts =cos_model_df[cos_model_df.full_name_mentee =='Desmond Roberts']
Desmond_Roberts
