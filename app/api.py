...
async def query_feedback(modify_option: str, mentee_id: Optional[str] = None, mentor_id: Optional[str] = None,
    ...
    - if modify_option == read -> supply ticket_id or mentor_id to view specific ticket or None to view all tickets
    - if modify_option == delete -> supply ticket_id to delete ticket
    """
    if modify_option == 'create' and (mentee_id, mentor_id, feedback):
        feedback_score,feedback_classification = vader_score(feedback)
        return {"result": API.db.create("Feedback", {"ticket_id": generate_uuid(16),
                                                     ...
                                                     'vader_classification': feedback_classification})}
